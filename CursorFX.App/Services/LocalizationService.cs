    ...
    private static readonly IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> Strings =
        new Dictionary<string, IReadOnlyDictionary<string, string>>(StringComparer.OrdinalIgnoreCase)
        {
            ["en"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                ["main.duplicateProfile"] = "Duplicate Profile",
                ["main.renameProfile"] = "Rename Profile",
                ["main.editProfileDescription"] = "Edit Description",
                ...
                ["main.diag.nextSteps.assemblyMissing"] = "Re-import the plugin package or replace the missing DLL, then use Reload to refresh the runtime.",
                ["main.diag.nextSteps.configIssue"] = "Replace this imported profile with a newer plugin build or re-import it from a valid DLL.",
                ["main.diag.nextSteps.runtimeError"] = "Try Reload first. If the error returns, switch to the safe profile and replace or debug the plugin build.",
                ["main.diag.nextSteps.hiddenCursor"] = "Make the cursor visible again or disable pause-on-hidden-cursor behavior for testing.",
                ["main.diag.nextSteps.noBackdrop"] = "If the plugin relies on screen distortion, test it on the desktop or another visible surface where backdrop sampling is available.",
                ["main.diag.nextSteps.noSnapshot"] = "Move back to a normal visible cursor state. Cursor-shape effects need a live cursor snapshot to render correctly.",
                ["main.diag.nextSteps.none"] = "No action is needed right now. The plugin runtime looks healthy.",
                ...
                ["main.effectOperation.updateProfileTitle"] = "Updating Profile",
                ["main.effectOperation.updateProfileMessage"] = "Fluxor is updating the profile name, description, and saved metadata.",
                ...
                ["main.status.profileUpdated"] = "Profile {0} updated.",
                ...
                ["profileMeta.rename.windowTitle"] = "Fluxor · Rename Profile",
                ["profileMeta.rename.heading"] = "Rename Profile",
                ["profileMeta.rename.intro"] = "Update the profile name and description without changing its identity or stored settings.",
                ["profileMeta.rename.confirm"] = "Save Changes",
                ["profileMeta.description.windowTitle"] = "Fluxor · Edit Profile Description",
                ["profileMeta.description.heading"] = "Edit Profile Description",
                ["profileMeta.description.intro"] = "Adjust the saved profile name or description and keep the current profile identity.",
                ["profileMeta.description.confirm"] = "Save Changes",
                ...
                ["diagDetails.windowTitle"] = "Fluxor | Plugin Diagnostics",
                ["diagDetails.heading"] = "Plugin Diagnostics Details",
                ["diagDetails.intro"] = "Review the current runtime state, warning context, and technical details for the selected external plugin.",
                ["diagDetails.summary"] = "Recommended next step",
                ["diagDetails.details"] = "Technical details",
                ["diagDetails.close"] = "Close",
