    ...
    private static readonly IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> Strings =
        new Dictionary<string, IReadOnlyDictionary<string, string>>(StringComparer.OrdinalIgnoreCase)
        {
            ["en"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                ["main.archiveImport.previewTitle"] = "Archive Preview",
                ["main.archiveImport.previewName"] = "Name: {0}",
                ["main.archiveImport.previewId"] = "Profile ID: {0}",
                ["main.archiveImport.previewRuntime"] = "Runtime: {0}",
                ["main.archiveImport.previewParameters"] = "Parameters: {0}",
                ["main.archiveImport.previewIcon"] = "Icon included: {0}",
                ["main.archiveImport.previewAssembly"] = "Plugin DLL included: {0}",
                ["main.archiveImport.previewWarnings"] = "Warnings:",
                ["main.archiveImport.previewReplacePrompt"] = "A profile with the same ID already exists: {0}",
                ["main.archiveImport.previewButtonsReplace"] = "Choose Yes to replace the existing profile, No to import this archive as a separate copy, or Cancel to stop.",
                ["main.archiveImport.previewButtonsImport"] = "Choose OK to import this profile archive or Cancel to stop.",
