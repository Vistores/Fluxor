    ...
    private static readonly IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> Strings =
        new Dictionary<string, IReadOnlyDictionary<string, string>>(StringComparer.OrdinalIgnoreCase)
        {
            ["en"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                ["main.archiveImport.dialogFilter"] = "Fluxor profile archive (*.fluxor-profile.zip)|*.fluxor-profile.zip|Zip archive (*.zip)|*.zip",
                ["main.archiveImport.success"] = "Profile {0} imported from archive.",
                ["main.archiveExport.dialogTitle"] = "Export Fluxor Profile Archive",
                ["main.archiveExport.dialogFilter"] = "Fluxor profile archive (*.fluxor-profile.zip)|*.fluxor-profile.zip|Zip archive (*.zip)|*.zip",
